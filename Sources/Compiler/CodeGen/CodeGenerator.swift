...
public struct CodeGenerator {
    ...
    private mutating func addImports() {
        let imports: [(String, String, [WASMType], [WASMType])] = [
            ...
            ("VertexTexCoords", "VertexTexCoords", [.i32, .i32, .f32, .f32, .f32], []),
            ...
            ("EntityAlpha", "EntityAlpha", [.i32, .f32], []),
            ("EntityColor", "EntityColor", [.i32, .f32, .f32, .f32], []),
            ("EntityFX", "EntityFX", [.i32, .i32], []),
            ("EntityBlend", "EntityBlend", [.i32, .i32], []),
            ("PointEntity", "PointEntity", [.i32, .i32], []),
            ("NameEntity", "NameEntity", [.i32, .i32], []),
            ("EntityName", "EntityName", [.i32], [.i32]),
