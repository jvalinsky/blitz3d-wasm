...
if (typeof require === "undefined") {
  window.require = function (path) {
    ...
    const moduleMap = {
      ...
      "animation": window.Blitz3DAnimationModule ||
        { Blitz3DAnimation: window.Blitz3DAnimation },
      "b3d": window.B3DLoader,
      "graphics": window.Blitz3DGraphics,
      "mesh": {
        Blitz3DSurface: window.Blitz3DSurface,
        Blitz3DWasmSurface: window.Blitz3DWasmSurface,
      },
