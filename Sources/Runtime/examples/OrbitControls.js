...
(function () {
  ...
  const _quat = new THREE.Quaternion().setFromUnitVectors(
  ...
  THREE.OrbitControls = function (object, domElement) {
    ...
    this.update = function () {
      ...
      if (
        ...
        panOffset.lengthSq() < EPS && Math.abs(scale - 1) < EPS
      ) return false;
    ...
    scope.domElement.addEventListener("contextmenu", function (e) {
      e.preventDefault();
    }, false);
    ...
    this.dispose = function () {
      scope.domElement.removeEventListener("contextmenu", function (e) {
        e.preventDefault();
      }, false);
      ...
      scope.domElement.removeEventListener("touchcancel", onTouchEnd, false);
      document.removeEventListener("mousemove", onMouseMove, false);
      document.removeEventListener("mouseup", onMouseUp, false);
    };
  ...
  THREE.OrbitControls.prototype.dispatchEvent =
  ...
  THREE.OrbitControls.prototype.removeEventListener =
