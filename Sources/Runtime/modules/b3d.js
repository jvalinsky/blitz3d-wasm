...
class B3DLoader {
    ...
    async loadFile(filePath, parentId) {
        ...
        try {
            ...
            if (window.Blitz3D && window.Blitz3D.engineExports && window.Blitz3D.engineExports.ParseB3D) {
    ...
    async createThreeJSFromWasm(meshId, parentId) {
        ...
        for (let i = 0; i < surfCount; i++) {
            ...
            geometry.setAttribute('color', new THREE.InterleavedBufferAttribute(interleavedBuffer, 3, 8));
