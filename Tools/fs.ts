...
export const walkFiles = async function* (root: string): AsyncGenerator<WalkFile> {
...
export const copyFile = async (src: string, dest: string, opts?: { overwrite?: boolean }) => {
  if (opts?.overwrite) {
    try {
...
export const copyDir = async (srcDir: string, destDir: string, opts?: { overwrite?: boolean }) => {
...
export const copy = async (src: string, dest: string, opts?: { overwrite?: boolean }) => {
