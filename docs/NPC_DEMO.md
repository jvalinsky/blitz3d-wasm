...
Browser-based viewer for SCPCB NPC models converted to SMPK format. Demonstrates:
...
Flashlight position: (0.15, -0.1, 0.3) relative to camera - simulates held position.
...
2. **Multi-texturing**: Detail textures 2-3 and cube textures require custom shaders
