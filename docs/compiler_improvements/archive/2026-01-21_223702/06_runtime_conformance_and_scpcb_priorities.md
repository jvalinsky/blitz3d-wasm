...
Ensure the browser runtime implements enough of the Blitz3D engine + DLL shims
to run SCPCB:
...
The compiler can be “correct” and still fail to run the game if imports are
missing or behaviorally wrong.
