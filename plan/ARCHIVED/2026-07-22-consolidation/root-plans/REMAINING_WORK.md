...
**Root cause**: Variables declared with wrong types, likely auto-declaration
issues\
...
**Reference**: Stack balancing algorithms documented in
`stack_balancing_algorithms` memory block
