...
**Created:** Mon Jan 19 2026 **Git Commit:**
b205e5af4ce548fe14e51d47995e0cc0c6d6f7fa **Goal:** Complete the Blitz3D WASM
compiler to fully compile and run SCP: Containment Breach in the browser.
...
- [ ] Update `Parser.parseTypeDeclaration` to capture `[expression]` after field
      names
- [ ] Update `CodeGenerator.processTypeDeclarations` to calculate offsets ×
      array size
...
1. **Asset Pipeline:** Need to integrate SCP:CB's asset loading system (B3D,
   textures, sounds)
