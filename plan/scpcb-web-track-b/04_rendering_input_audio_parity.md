...
- [x] Fog:
  - [x] implement Blitz-style fog parameters and per-room overrides (2026-01-29: `web/src/runtime/graphics.ts`)
- [x] Alpha + sorting:
  - [x] correct handling for transparent materials (2026-01-29: `BrushAlpha` / `EntityAlpha` support)
- [ ] Performance:
...
- [x] Keyboard mapping parity (edge cases: key repeat, focus loss). (2026-01-29: `web/src/runtime/graphics.ts` via physical scancodes)
- [x] Mouse:
