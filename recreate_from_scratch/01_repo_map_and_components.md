...
This file is a reconstruction-oriented inventory: what exists, what it does, and
what the **minimum viable subset** would be for a clean-room rebuild.
...
- Tools: `Tools/`
- Docs: `docs/SMPK_SYSTEM.md`, `docs/ASSET_PIPELINE.md`,
  `docs/FILE_FORMAT_LOADERS.md`
