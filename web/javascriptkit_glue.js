...
function createJavaScriptKitImports(memory) {
    ...
    return {
        ...
        _JSValueIsObject: (id) => typeof JSKit_obj_storage[id] === 'object' && JSKit_obj_storage[id] !== null,
        ...
        swjs_create_function: (host_func_id, line, file) => {
            ...
            const id = JSKit_obj_id_counter++;
            JSKit_obj_storage[id] = () => { console.warn("Called a stubbed JSKit function"); };
            return id;
        },
        ...
        swjs_call_function: (obj_id, func_id, args_ptr, args_len) => {
            const id = JSKit_obj_id_counter++; JSKit_obj_storage[id] = undefined; return id;
        },
        ...
        swjs_call_function_with_this_no_catch: (obj_id, func_id, args_ptr, args_len) => {
            const id = JSKit_obj_id_counter++; JSKit_obj_storage[id] = undefined; return id;
        },
        swjs_release: (obj_id) => {
        ...
        swjs_call_throwing_new: (obj_id, args_ptr, args_len, exception_obj_ptr) => {
            const id = JSKit_obj_id_counter++; JSKit_obj_storage[id] = { _isStub: true }; return id;
        },
        swjs_call_throwing_function: (obj_id, func_id, args_ptr, args_len, exception_obj_ptr) => {
            const id = JSKit_obj_id_counter++; JSKit_obj_storage[id] = undefined; return id;
        },
        swjs_call_throwing_function_with_this: (obj_id, func_id, args_ptr, args_len, exception_obj_ptr) => {
            const id = JSKit_obj_id_counter++; JSKit_obj_storage[id] = undefined; return id;
        },
        swjs_create_typed_array: (constructor_id, ptr, length, release_callback_id) => {
            const id = JSKit_obj_id_counter++; JSKit_obj_storage[id] = new Uint8Array(length); return id;
        },
