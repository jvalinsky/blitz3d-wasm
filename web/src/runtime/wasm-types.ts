...
export interface GraphicsExports {
    ...
    RotateMesh: (handle: number, pitch: number, yaw: number, roll: number) => void;
    PositionMesh: (handle: number, x: number, y: number, z: number) => void;
    FitMesh: (handle: number, x: number, y: number, z: number, width: number, height: number, depth: number) => void;
...
export interface EntityExports {
    ...
    RotateEntity: (handle: number, pitch: number, yaw: number, roll: number) => void;
    ScaleEntity: (handle: number, x: number, y: number, z: number) => void;
    MoveEntity: (handle: number, x: number, y: number, z: number) => void;
    TurnEntity: (handle: number, pitch: number, yaw: number, roll: number) => void;
...
export interface CameraExports {
    CreateCamera: () => number;
    CameraViewport: (handle: number, x: number, y: number, width: number, height: number) => void;
...
export interface AudioExports {
    ...
    PlaySound: (handle: number, volume: number, pan: number, rate: number, loop: number) => number;
 ...
 */
export interface Blitz3DEngineExports extends
    WasmMemoryExports,
    BankExports,
    StringExports,
    MathExports,
